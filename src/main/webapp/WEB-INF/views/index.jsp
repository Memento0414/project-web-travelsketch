...
<div class="back-img" style="flex: 3; display: flex; justify-content: center; align-items: center;">
...
<%-- 메인~검색컨트롤러 --%>
<div class="belt">
	<table style="margin: auto; width: 1300px; display: flex; justify-content: center;">
		<tbody>
			<c:choose>
					...
					<c:forEach items="${campingList}" var="obj">
						<tr class="camping-item"
							...
							<td style="width: 20%; max-width: 270px;"><img
								style="border-radius: 50%; width: 140px; height: 140px; margin: 15px;"
				...
				<c:otherwise>
					<c:forEach items="${campingList}" var="obj">
						<tr class="camping-item"
							onclick="location.href='/detail?contentId=${obj.contentId}'">
							<td style="width: 20%; max-width: 250px;"><img
								style="border-radius: 50%; width: 140px; height: 140px; margin: 15px;"
								src="${obj.firstImageUrl}"
								onerror="this.src='/resource/image/tent.png'" /> <br> <b>${obj.facltNm.replace("(주)", "")}</b>
								<br>
